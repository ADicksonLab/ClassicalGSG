...
from classicalgsg.molecular_models.GSGraph import GSGraph
from classicalgsg.molecular_models.utility import  adjacency_matrix
from classicalgsg.molecule_features.classicalgsg import ClassicalMD
    ...
    def create(self, wavelet_num_steps, features, dataset_save_path,
        ...
        for idx, mol2_file_name in enumerate(mol2_files):
            ...
            if all(osp.isfile(mol_path) for mol_path in all_paths):
                ...
                if coords.shape[0] == len(cgenff_molecule):
